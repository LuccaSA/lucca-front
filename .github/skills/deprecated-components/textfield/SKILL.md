...
#### Table de correspondance legacy -> `FormLabel.size`

`FormLabel.size` accepte uniquement `XS` et `S`.
Les classes legacy de largeur (`mod-short`, `mod-long`, etc.) ne doivent donc pas etre mappees vers `size`.

| Classe legacy | `FormLabel.size` | Regle de migration |
| --- | --- | --- |
| `mod-XS` | `XS` | mapper vers `size="XS"` sur `lu-form-field` |
| `mod-S` | `S` | mapper vers `size="S"` sur `lu-form-field` |
| `mod-shortest` | n/a | ne pas mapper sur `size` ; conserver/traiter comme contrainte de largeur |
| `mod-shorter` | n/a | ne pas mapper sur `size` ; conserver/traiter comme contrainte de largeur |
| `mod-short` | n/a | ne pas mapper sur `size` ; conserver/traiter comme contrainte de largeur |
| `mod-standard` / `mod-default` | n/a | ne pas mapper sur `size` |
| `mod-long` | n/a | ne pas mapper sur `size` ; conserver/traiter comme contrainte de largeur |
| `mod-longer` | n/a | ne pas mapper sur `size` ; conserver/traiter comme contrainte de largeur |
| `mod-longest` | n/a | ne pas mapper sur `size` ; conserver/traiter comme contrainte de largeur |
