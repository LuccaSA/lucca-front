# Migrations Lucca Front — jusqu'à v21.0.4
...
> Source : `packages/ng/schematics/collection.json` au tag v21.0.4. Liste cumulative.
> Guidance prose (étapes manuelles, contexte) : `./documentation/deprecated/deprecated.md`.

## Catalogue complet (cumulatif ≤ v21.0.4)
