...
L'utilisateur clique sur la ressource et accède à une **pleine page dédiée**, organisée en plusieurs sections reflétant la structure du parcours de création.
