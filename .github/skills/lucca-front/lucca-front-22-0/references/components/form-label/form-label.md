...
~ `error` : transform booleanAttribute → luBooleanAttribute
~ `counterStatus` : transform numberAttribute → luNumberAttribute
~ `counterMax` : transform numberAttribute → luNumberAttribute
