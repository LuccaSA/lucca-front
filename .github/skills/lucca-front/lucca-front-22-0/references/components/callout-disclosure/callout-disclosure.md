...
- 📖 [Storybook documentation](https://lucca-front.lucca.io/v22.0.0/storybook/?path=/docs/documentation-feedback-callout-disclosure-angular--docs)
...
~ `open` : transform booleanAttribute → luBooleanAttribute
