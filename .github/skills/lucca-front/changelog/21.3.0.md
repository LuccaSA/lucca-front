...
**Résumé** : 25 ajouté(s), 119 modifié(s), 9 supprimé(s)
...
- ➖ `references/components/card/design/_index.md` supprimé (10 lignes)
- ➖ `references/components/card/design/content.md` supprimé (33 lignes)
- ➖ `references/components/duration-picker/stories/html-picker-angular.md` supprimé (10 lignes)
- ➖ `references/components/phonenumberfield/design/_index.md` supprimé (10 lignes)
- ➖ `references/components/phonenumberfield/design/design.md` supprimé (56 lignes)
...
- ➖ `references/components/card/design/content.md` (33 lignes)
...
- 🔄 `references/components/dialog/stories/html-dialog.md` (190 → 190, +0)
...
- ➖ `references/components/phonenumberfield/design/_index.md` (10 lignes)
- ➖ `references/components/phonenumberfield/design/design.md` (56 lignes)
- 🔄 `references/components/phonenumberfield/phonenumberfield.component.md` (12 → 10, -2)
...
- 🔄 `references/components/phonenumberfield/phonenumberfield.md` (38 → 38, +0)
