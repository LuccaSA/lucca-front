...
**Résumé** : 2 ajouté(s), 23 modifié(s), 0 supprimé(s)
...
- 🔄 `references/components/dialog/dialog.md` (75 → 79, +4)
...
- 🔄 `references/components/dialog/stories/html-dialog.md` (189 → 190, +1)
...
- 🔄 `references/components/fancy-dialog/fancy-dialog.md` (73 → 77, +4)
