...
**Résumé** : 37 ajouté(s), 181 modifié(s), 1 supprimé(s)
...
- `activity-feed/design/design.md` (65 lignes)
...
- `empty-state/stories/angular-state-page-onboarding.md` (37 lignes)
...
- `form-label/stories/angular-label-basic.md` (11 lignes)
...
- `multi-select/design/design-android.md` (59 lignes)
- `multi-select/design/design-ios.md` (53 lignes)
- `progress-stepper/design/_index.md` (10 lignes)
- `progress-stepper/design/design.md` (51 lignes)
- `progress-stepper/progress-stepper.component.md` (23 lignes)
- `progress-stepper/progress-stepper.md` (47 lignes)
- `progress-stepper/stories/angular-basic.md` (18 lignes)
...
- `simple-select/design/design-android.md` (58 lignes)
- `simple-select/design/design-ios.md` (52 lignes)
- `userpopover/design/design.md` (71 lignes)
...
- `app-layout/design/design.md` (56 → 58 lignes, +2)
...
- `bubble-icon/design/design.md` (40 → 44 lignes, +4)
...
- `calendar/design/design.md` (36 → 40 lignes, +4)
...
- `checkbox/design/design.md` (90 → 94 lignes, +4)
...
- `clear/design/design.md` (31 → 33 lignes, +2)
...
- `color-picker/design/design.md` (35 → 39 lignes, +4)
...
- `comment/design/design.md` (38 → 42 lignes, +4)
...
- `data-table/design/design.md` (114 → 118 lignes, +4)
...
- `dateinput/design/design.md` (63 → 67 lignes, +4)
...
- `daterangeinput/design/design.md` (63 → 67 lignes, +4)
...
- `empty-state/stories/angular-state-page.md` (24 → 23 lignes, -1)
...
- `fancybox/design/design.md` (59 → 63 lignes, +4)
...
- `fileentry/design/design.md` (89 → 93 lignes, +4)
...
- `fileentry/stories/angular-basic.md` (21 → 23 lignes, +2)
...
- `fileupload/design/design.md` (89 → 93 lignes, +4)
...
- `filterbar/design/design.md` (70 → 85 lignes, +15)
...
- `filterpills/design/design.md` (40 → 44 lignes, +4)
...
- `highlight-data/design/design.md` (81 → 85 lignes, +4)
...
- `icons/design/design.md` (115 → 119 lignes, +4)
...
- `index-table/index-table.component.md` (47 → 51 lignes, +4)
...
- `input-framed/design/design.md` (83 → 85 lignes, +2)
...
- `loading/loading.md` (37 → 38 lignes, +1)
...
- `multi-select/design/design.md` (153 → 157 lignes, +4)
...
- `multilanguagefield/design/design.md` (97 → 48 lignes, -49)
...
- `pageheader/pageheader.md` (36 → 37 lignes, +1)
...
- `pageheader/stories/angular-header-basic.md` (23 → 23 lignes, +0)
...
- `phonenumberfield/design/design.md` (52 → 56 lignes, +4)
...
- `radiofield/design/design.md` (115 → 119 lignes, +4)
...
- `radiofield/stories/angular-field.md` (9 → 25 lignes, +16)
...
- `richtextinput/design/design.md` (70 → 72 lignes, +2)
...
- `simple-select/design/design.md` (138 → 142 lignes, +4)
...
- `software-icon/design/design.md` (10 → 20 lignes, +10)
...
- `statusbadge/design/design.md` (55 → 55 lignes, +0)
...
- `userpopover/design/vue-d-ensemble.md` (71 lignes)
...
- `content/infinitif-imperatif.md` (64 → 22 lignes, -42)
...
- `patterns/pattern-ia.md` (107 → 112 lignes, +5)
