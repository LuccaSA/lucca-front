...
**Résumé** : 29 ajouté(s), 150 modifié(s), 6 supprimé(s)
...
- ➖ `references/documentation/tokens/noms-de-logiciels.md` supprimé (82 lignes)
...
- 🔄 `references/components/callout-popover/callout-popover.md` (45 → 45, +0)
...
- ➖ `references/documentation/tokens/noms-de-logiciels.md` (82 lignes)
