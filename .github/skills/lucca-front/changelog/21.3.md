...
**Résumé** : 12 ajouté(s), 137 modifié(s), 0 supprimé(s)
...
- 📉 `references/components/button/button.design.md` réduit (304 → 298 lignes)
- 📉 `references/components/fileentry/fileentry.design.md` réduit (135 → 133 lignes)
- 📉 `references/components/fileupload/fileupload.design.md` réduit (135 → 133 lignes)
...
- 🔄 `references/components/activity-feed/activity-feed.component.md` (213 → 213, +0)
...
- 🔄 `references/components/activity-feed/activity-feed.md` (53 → 53, +0)
...
- 🔄 `references/components/avatar/avatar.component.md` (574 → 574, +0)
...
- 🔄 `references/components/avatar/avatar.md` (43 → 45, +2)
...
- 🔄 `references/components/box/box.md` (41 → 42, +1)
...
- 🔄 `references/components/bubble-icon/bubble-icon.md` (44 → 41, -3)
...
- 🔄 `references/components/bubble-illustration/bubble-illustration.component.md` (32 → 51, +19)
...
- 🔄 `references/components/bubble-illustration/bubble-illustration.md` (40 → 34, -6)
...
- 🔄 `references/components/button/button.component.md` (253 → 253, +0)
...
- 🔄 `references/components/button/button.design.md` (304 → 298, -6)
...
- 🔄 `references/components/callout/callout.design.md` (105 → 180, +75)
  ...
  +#### Message unique
  +
  @@ ... 91 changement(s) supplémentaire(s) @@
  ````
...
- 🔄 `references/components/callout-disclosure/callout-disclosure.design.md` (105 → 180, +75)
...
- 🔄 `references/components/callout-popover/callout-popover.design.md` (105 → 180, +75)
...
- 🔄 `references/components/checkbox/checkbox.component.md` (92 → 92, +0)
...
- 🔄 `references/components/chip/chip.component.md` (131 → 131, +0)
...
- 🔄 `references/components/clear/clear.component.md` (38 → 39, +1)
...
- 🔄 `references/components/color-picker/color-picker.component.md` (33 → 35, +2)
...
- 🔄 `references/components/container/container.component.md` (30 → 30, +0)
...
- 🔄 `references/components/core-select-department/core-select-department.md` (29 → 30, +1)
...
- 🔄 `references/components/data-table/data-table.component.md` (1536 → 1589, +53)
  ...
  +				</td>
  +			</tr>
  @@ ... 17 changement(s) supplémentaire(s) @@
  ````

- 🔄 `references/components/data-table/data-table.md` (120 → 126, +6)
...
- 🔄 `references/components/dateinput/dateinput.design.md` (77 → 77, +0)
...
- 🔄 `references/components/daterangeinput/daterangeinput.design.md` (77 → 77, +0)
...
- 🔄 `references/components/dialog/dialog.component.md` (362 → 364, +2)
...
- 🔄 `references/components/divider/divider.component.md` (36 → 36, +0)
...
- 🔄 `references/components/duration-picker/duration-picker.component.md` (20 → 6, -14)
...
- 🔄 `references/components/duration-picker/duration-picker.md` (49 → 47, -2)
...
- 🔄 `references/components/empty-state/empty-state.component.md` (227 → 228, +1)
...
- 🔄 `references/components/fieldset/fieldset.component.md` (87 → 88, +1)
...
- 🔄 `references/components/fieldset/fieldset.md` (45 → 46, +1)
...
- 🔄 `references/components/fileentry/fileentry.design.md` (135 → 133, -2)
...
- 🔄 `references/components/fileupload/fileupload.design.md` (135 → 133, -2)
...
- 🔄 `references/components/filterbar/filterbar.component.md` (220 → 167, -53)
...
- 🔄 `references/components/filterpills/filterpills.component.md` (63 → 63, +0)
...
- 🔄 `references/components/filterpills/filterpills.design.md` (61 → 61, +0)
...
- 🔄 `references/components/footer/footer.component.md` (67 → 67, +0)
...
- 🔄 `references/components/footer/footer.design.md` (150 → 164, +14)
...
- 🔄 `references/components/gauge/gauge.component.md` (55 → 56, +1)
...
- 🔄 `references/components/grid/grid.md` (45 → 49, +4)
...
- 🔄 `references/components/highlight-data/highlight-data.design.md` (98 → 98, +0)
...
- 🔄 `references/components/highlight-data/highlight-data.md` (42 → 46, +4)
...
- ➕ `references/components/highlight-text/highlight-text.component.md` (48 lignes)
- ➕ `references/components/highlight-text/highlight-text.md` (38 lignes)

## components/horizontalnavigation

- 🔄 `references/components/horizontalnavigation/horizontalnavigation.component.md` (159 → 233, +74)
  ...
  +				tabindex="-1"
  +			>
  @@ ... 29 changement(s) supplémentaire(s) @@
  ````

- 🔄 `references/components/horizontalnavigation/horizontalnavigation.md` (41 → 59, +18)
...
- ➕ `references/components/impersonation/impersonation.component.md` (56 lignes)
- ➕ `references/components/impersonation/impersonation.md` (53 lignes)

## components/index-table

- 🔄 `references/components/index-table/index-table.component.md` (2251 → 2255, +4)
...
- 🔄 `references/components/index-table/index-table.md` (118 → 124, +6)
...
- 🔄 `references/components/inlinemessage/inlinemessage.component.md` (65 → 65, +0)
...
- 🔄 `references/components/input-framed/input-framed.component.md` (726 → 726, +0)
...
- 🔄 `references/components/link/link.component.md` (79 → 144, +65)
...
- 🔄 `references/components/link/link.md` (36 → 43, +7)
...
- 🔄 `references/components/listbox/listbox.md` (46 → 46, +0)
...
- 🔄 `references/components/loading/loading.design.md` (31 → 33, +2)
...
- 🔄 `references/components/main-layout/main-layout.component.md` (145 → 147, +2)
...
- 🔄 `references/components/multilanguagefield/multilanguagefield.component.md` (22 → 75, +53)
...
- 🔄 `references/components/multilanguagefield/multilanguagefield.design.md` (52 → 79, +27)
...
- 🔄 `references/components/multilanguagefield/multilanguagefield.md` (30 → 39, +9)
...
- ➕ `references/components/newbadge/newbadge.design.md` (26 lignes)
- 🔄 `references/components/newbadge/newbadge.md` (27 → 27, +0)
...
- 🔄 `references/components/numericbadge/numericbadge.component.md` (66 → 67, +1)
...
- 🔄 `references/components/pageheader/pageheader.component.md` (386 → 390, +4)
...
- 🔄 `references/components/pagination/pagination.component.md` (93 → 93, +0)
...
- 🔄 `references/components/phonenumberfield/phonenumberfield.component.md` (18 → 19, +1)
...
- 🔄 `references/components/popover/popover.component.md` (124 → 85, -39)
...
- 🔄 `references/components/popover2/popover2.component.md` (87 → 101, +14)
...
- 🔄 `references/components/popover2/popover2.md` (73 → 75, +2)
...
- 🔄 `references/components/progress-bar/progress-bar.component.md` (31 → 31, +0)
...
- 🔄 `references/components/radiofield/radiofield.component.md` (300 → 301, +1)
...
- 🔄 `references/components/readmore/readmore.component.md` (61 → 54, -7)
...
- 🔄 `references/components/richtextinput/richtextinput.design.md` (82 → 84, +2)
...
- 🔄 `references/components/scrollbox/scrollbox.component.md` (65 → 65, +0)
...
- 🔄 `references/components/select/select.component.md` (237 → 228, -9)
...
- 🔄 `references/components/select-templating/select-templating.md` (103 → 104, +1)
...
- ➕ `references/components/skeleton/skeleton.design.md` (83 lignes)
- 🔄 `references/components/skeleton/skeleton.md` (100 → 104, +4)
...
- 🔄 `references/components/skiplinks/skiplinks.component.md` (55 → 61, +6)
...
- 🔄 `references/components/skiplinks/skiplinks.md` (33 → 51, +18)
...
- 🔄 `references/components/sortable-list/sortable-list.component.md` (127 → 134, +7)
...
- 🔄 `references/components/statusbadge/statusbadge.component.md` (56 → 57, +1)
...
- 🔄 `references/components/switchfield/switchfield.component.md` (118 → 119, +1)
...
- 🔄 `references/components/tags/tags.component.md` (74 → 74, +0)
...
- ➕ `references/components/tags/tags.design.md` (85 lignes)
...
- 🔄 `references/components/textareafield/textareafield.component.md` (51 → 52, +1)
...
- 🔄 `references/components/textfield/textfield.component.md` (623 → 624, +1)
...
- 🔄 `references/components/tile/tile.component.md` (108 → 95, -13)
...
- ➕ `references/components/time/time.component.md` (272 lignes)
- ➕ `references/components/time/time.md` (128 lignes)

## components/time-picker

- 🔄 `references/components/time-picker/time-picker.component.md` (81 → 6, -75)
...
- 🔄 `references/components/time-picker/time-picker.md` (49 → 51, +2)
...
- 🔄 `references/components/tooltip/tooltip.component.md` (72 → 82, +10)
...
- 🔄 `references/documentation/patterns/dialogs-confirmation.md` (110 → 138, +28)
  ...
  @@ ... 64 changement(s) supplémentaire(s) @@
  ````
...
- 🔄 `references/documentation/patterns/traduction-formulaire.md` (110 → 118, +8)
