...
- 📉 `references/documentation/patterns/regles-or.md` réduit (104 → 94 lignes)
...
- 🔄 `references/components/api-select/api-select.md` (35 → 35, +0)
...
- 🔄 `references/components/avatar/avatar.md` (44 → 46, +2)
...
- 🔄 `references/components/box/box.md` (42 → 43, +1)
...
- 🔄 `references/components/button/button.md` (43 → 44, +1)
...
- 🔄 `references/components/button/stories/html-states.md` (14 → 14, +0)
...
- 🔄 `references/components/callout-popover/callout-popover.md` (51 → 51, +0)
...
- 🔄 `references/components/core-select-department/core-select-department.md` (31 → 32, +1)
...
- 🔄 `references/components/data-table/data-table.md` (121 → 127, +6)
...
- 🔄 `references/components/duration-picker/duration-picker.md` (50 → 49, -1)
...
- 🔄 `references/components/fileentry/fileentry.md` (79 → 80, +1)
...
- 🔄 `references/components/fileupload/fileupload.md` (79 → 80, +1)
...
- 🔄 `references/components/index-table/index-table.md` (119 → 125, +6)
...
- 🔄 `references/components/input-framed/input-framed.md` (44 → 44, +0)
...
- 🔄 `references/components/link/link.component.md` (30 → 31, +1)
...
- 🔄 `references/components/link/link.md` (37 → 44, +7)
...
- 🔄 `references/components/main-layout/stories/angular-inAppLayout.md` (36 → 37, +1)
...
- 🔄 `references/components/main-layout/stories/html-inAppLayout.md` (40 → 41, +1)
...
- 🔄 `references/components/popover2/popover2.md` (74 → 76, +2)
...
- 🔄 `references/components/select-templating/select-templating.md` (105 → 106, +1)
...
- 🔄 `references/components/simple-select/simple-select.md` (39 → 40, +1)
...
- 🔄 `references/components/skiplinks/skiplinks.md` (34 → 52, +18)
...
- 🔄 `references/components/software-icon/software-icon.md` (50 → 50, +0)
...
- 🔄 `references/components/sortable-list/stories/angular-draggable.md` (8 → 15, +7)
...
- 🔄 `references/components/tile/tile.md` (36 → 36, +0)
...
- ➕ `references/components/time/time.md` (104 lignes)
...
- 🔄 `references/components/time-picker/time-picker.md` (50 → 53, +3)
...
- 🔄 `references/documentation/patterns/regles-or.md` (104 → 94, -10)
...
- 🔄 `references/documentation/tokens/elevations.md` (79 → 79, +0)
...
- 🔄 `references/migrations.md` (29 → 31, +2)
...
- 🔄 `references/tools/angular-api.md` (328 → 329, +1)
