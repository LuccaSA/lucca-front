# Migrations Lucca Front — jusqu'à v21.1.2
...
> Source : `packages/ng/schematics/collection.json` au tag v21.1.2. Liste cumulative.
> Guidance prose (étapes manuelles, contexte) : `./documentation/deprecated/deprecated.md`.

## Catalogue complet (cumulatif ≤ v21.1.2)
