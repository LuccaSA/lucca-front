# Migrations Lucca Front — jusqu'à v21.2.4
...
> Source : `packages/ng/schematics/collection.json` au tag v21.2.4. Liste cumulative.
> Guidance prose (étapes manuelles, contexte) : `./documentation/deprecated/deprecated.md`.

## Catalogue complet (cumulatif ≤ v21.2.4)
