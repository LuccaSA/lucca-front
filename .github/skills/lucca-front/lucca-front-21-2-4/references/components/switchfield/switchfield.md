...
| `size` | `size` | `'L' \| null` | `null` | — | — | Modifie la taille du switch. |
...
- 📖 [Storybook documentation](https://lucca-front.lucca.io/v21.2.4/storybook/?path=/docs/documentation-forms-fields-switchfield-angular--docs)
