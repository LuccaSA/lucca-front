# Migrations Lucca Front — jusqu'à v21.0.5
...
> Source : `packages/ng/schematics/collection.json` au tag v21.0.5. Liste cumulative.
> Guidance prose (étapes manuelles, contexte) : `./documentation/deprecated/deprecated.md`.

## Catalogue complet (cumulatif ≤ v21.0.5)
