...
- 📖 [Storybook documentation](https://lucca-front.lucca.io/v22.0.0/storybook/?path=/docs/documentation-forms-fields-multilanguagefield-angular--docs)
...
~ `openOnFocus` : transform booleanAttribute → luBooleanAttribute
~ `hasNoInvariant` : transform booleanAttribute → luBooleanAttribute
~ `hasAIButtons` : transform booleanAttribute → luBooleanAttribute
