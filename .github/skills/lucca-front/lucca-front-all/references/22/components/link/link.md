...
`LinkComponent` :
  ...
  ~ `decorationHover` : transform booleanAttribute → luBooleanAttribute
  ~ `external` : transform booleanAttribute → luBooleanAttribute
  ~ `hiddenIcon` : transform booleanAttribute → luBooleanAttribute
