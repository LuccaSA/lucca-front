...
title: Parcours de création de ressource
description: Ce pattern structure l'expérience utilisateur lors de la création d'une nouvelle ressource dans les logiciels Lucca.
---
