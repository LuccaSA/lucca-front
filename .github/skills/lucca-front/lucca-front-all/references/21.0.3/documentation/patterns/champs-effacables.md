...
Pour indiquer que le contenu d'un champ est effaçable, nous utilisons le composant Clear. En aucun cas, un autre composant ou une icône ne doit être utilisé pour cet usage.
