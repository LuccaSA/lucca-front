...
Applique la couleur produit à un texte. Nécessite une configuration.
...
Ajoute une animation lors de l'apparition de l'élément. Pour des animations plus complète, notamment avant la suppression d'un élément, consultez le module d'animations Angular. 
...
```html
<p>J’ai besoin d’aide <span aria-hidden="true" class="lucca-icon icon-signHelp pr-u-help"></span><span class="pr-u-mask">?</span></p>
```
