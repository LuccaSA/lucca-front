...
- 📖 [Storybook documentation](https://lucca-front.lucca.io/v21.3.1/storybook/?path=/docs/documentation-file-fileentry-angular-basic--docs)
...
`FileEntryComponent` :
  ~ `size` : 'S' | null → FileEntrySize | null
