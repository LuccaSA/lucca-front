# Migrations Lucca Front — jusqu'à v21.3.1
...
> Source : `packages/ng/schematics/collection.json` au tag v21.3.1. Liste cumulative.
> Guidance prose (étapes manuelles, contexte) : `./documentation/deprecated/deprecated.md`.

## Catalogue complet (cumulatif ≤ v21.3.1)
