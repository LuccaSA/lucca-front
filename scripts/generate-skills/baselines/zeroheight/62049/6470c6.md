...
L'utilisateur clique sur la ressource et accède à une **pleine page dédiée**, organisée en plusieurs sections (via le composant [HorizontalNavigation](https://prisme.lucca.io/94310e217/p/29aaef)) reflétant la structure du parcours de création.
