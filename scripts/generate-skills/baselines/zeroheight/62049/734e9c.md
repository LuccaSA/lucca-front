...
description: Le design responsive est un enjeu majeur pour rendre nos interfaces utilisables par un panel d'utilisateurs aux contextes très différents.
---
...
Ces variables permettent de définir des conditions liées à la largeur du *viewport*. Elles peuvent également être appelées via des *[mixins](https://prisme.lucca.io/94310e217/p/94f032-mixins/t/09d9f0)*.
