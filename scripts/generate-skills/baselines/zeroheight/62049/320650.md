---
title: Card et box
description: Les Cards et les Box sont des éléments importants pour construire une interface Lucca. Elles permettent de naviguer, hiérarchiser l'information, structurer le contenu.
---
