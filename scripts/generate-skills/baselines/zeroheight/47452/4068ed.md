...
| Dialog / Performance / Initialization | 📝 Design pattern documentation [Do not use!] |
...
[Docs](https://lucca-front.lucca.io/storybook/iframe.html?id=documentation-overlays-modal--docs)
