---
title: Modal
description: Les fenêtres de dialogue viennent superposer un contenu supplémentaire sans quitter la page en cours. Elles ont diverses utilités comme la création ou l'édition de contenu, la confirmation ou l'accès à des fonctionnalités avancées.
---
...
🚧 Modal utilise aujourd'hui le nouveau service [Dialog](https://prisme.lucca.io/94310e217/p/841b0b-dialogs/b/6696ab) par défaut. Il est prévu de la conserver en tant qu'outil permettant de créer rapidement une fenêtre de dialogue et sera ainsi renommée dans le futur.
...
| Name | Library |
| :--- | :--- |
| Dialog/ExitDialog/type=default | 🧩 Lucca components v21.2 |
| Dialog / Performance / Initialization | 📝 Patterns documentation [Do not use!] |
...
[Docs](https://lucca-front.lucca.io/master/storybook/iframe.html?id=documentation-overlays-modal--docs)
