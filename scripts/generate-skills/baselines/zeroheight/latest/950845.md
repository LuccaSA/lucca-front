---
title: Sans action de diffusion
description: Ce pattern s'applique aux ressources créées et appliquées immédiatement à la validation, sans étape de diffusion intermédiaire (ex : éléments de paramétrage).
---
...
Le formulaire peut être structuré en plusieurs fieldsets pour maintenir une bonne lisibilité. Une [guideline sur les formulaire](https://prisme.lucca.io/94310e217/p/53a634-conception-dun-formulaire) est disponible pour aider à construire un formulaire.
...
Pour en savoir, vous pouvez [consulter la guideline dédiée à la gestion des erreurs dans un formulaire](https://prisme.lucca.io/94310e217/p/94e1ec).
...
Les actions critiques comme la suppression doivent être suivi d’une Dialog de confirmation de suppression, comme [mentionné dans la guideline dédiée](https://prisme.lucca.io/94310e217/p/0477a2-dialogs-de-confirmation/t/ced234fc87).

#### Actions métier

Si des actions métier sont disponibles, celles-ci doivent être positionnées dans le Footer de la Dialog, en respectant les règles d’ordre d’affichage définit dans la [guideline du composant Button](https://prisme.lucca.io/94310e217/p/098404-button/t/55c1a04a80).
