---
title: Arrondis  🎉
description: Les radius améliorent la cohérence visuelle et la hiérarchisation de l’information dans nos interfaces.
---
...
À l’inverse, certains composants habituellement en 8px (`--pr-t-border-radius-default`), peuvent exceptionnellement passer à 12px (`--pr-t-border-radius-structure`) lorsqu’ils prennent une dimension plus structurante dans une interface. C’est notamment le cas du [File upload](https://prisme.lucca.io/94310e217/p/8282a5-file-upload) et du [Callout](https://prisme.lucca.io/94310e217/p/64c8d8-callout).
