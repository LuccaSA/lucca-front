...
description: Un champ conditionnel s'affiche en fonction d'un choix fait en amont dans le formulaire. Il n'apparaît que si ce choix le rend pertinent.
---
...
Ici s'applique notre principe [Don't make me think](https://prisme.lucca.io/94310e217/p/21fd83) :
...
Le champ conditionnel se place dans le flux du formulaire, sous ou a proximité immédiate du champ qui le déclenche. Pour en regrouper plusieurs, utilisons un [Input framed](https://prisme.lucca.io/94310e217/p/28896d).
