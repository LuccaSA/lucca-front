---
title: Time and Duration picker
description: Le Duration picker permet à l'utilisateur de définir une durée. Le Time picker, quant à lui, permet de saisir une heure de la journée. Le comportement des deux champs est similaire.
---
...
Si un champ obligatoire n’est pas renseigné, une erreur sera remontée à la soumission du formulaire. Pour en savoir plus, vous pouvez vous référer à la [guideline sur les formulaires](https://prisme.lucca.io/94310e217/p/133ac2).
...
Dans le cas d’un formulaire, la largeur du champ peut s’adapter à la [grille de construction d’un formulaire](https://prisme.lucca.io/94310e217/p/2143a6). Le champ ne peut en revanche pas prendre une largeur plus grande qu’une colonne.
...
[Basic](https://lucca-front.lucca.io/master/storybook/iframe.html?id=documentation-forms-time-time-picker-angular-form--basic)

</tab>
<tab>

<tab-title>**Duration**</tab-title>
...
[Basic](https://lucca-front.lucca.io/master/storybook/iframe.html?id=documentation-forms-time-duration-picker-angular-form--basic)
