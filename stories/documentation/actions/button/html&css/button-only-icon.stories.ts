...
<button type="button" class="button mod-ghost mod-onlyIcon"><span aria-hidden="true" class="lucca-icon icon-heart"></span><span class="pr-u-mask">Liker</span></button>
<button type="button" class="button mod-outlined mod-onlyIcon mod-critical"><span aria-hidden="true" class="lucca-icon icon-trashDelete"></span><span class="pr-u-mask">Supprimer</span></button>
