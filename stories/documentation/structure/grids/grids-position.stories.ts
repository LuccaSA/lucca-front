...
function getTemplate(args: GridsPositionStory): string {
	return `<div class="grid rwd-autoContainer" style="--grid-columns: 4">
...
<div class="grid rwd-autoContainer" style="--grid-columns: 4">
	<div class="grid-column" style="--grid-column: 2"><div class="demo">column 2</div></div>
...
<div class="grid rwd-autoContainer mod-dense" style="--grid-columns: 4">
