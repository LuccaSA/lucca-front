...
export default {
	...
	argTypes: {
		direction: {
			options: ['mod-notchTop', 'mod-notchLeft'],
			control: {
				type: 'select',
			},
		},
...
Basic.args = { direction: 'mod-notchTop', notchPosition: 50, notchWidth: 56, notchHeight: 24, notchInnerRadius: 18, notchOuterRadius: 8, badgeWidth: 48, badgeHeight: 48, badgeRadius: 14, badgeOffset: 17 };
