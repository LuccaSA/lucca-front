...
export default {
	title: 'Documentation/Navigation/viewTabs/Basic',
	argTypes: {
		size: {
...
<ul class="viewTabs ${args.size}" role="tablist">
	...
	<li class="viewTabs-item" role="presentation">
		<button class="viewTabs-item-tab" type="button" role="tab" id="tab2" aria-controls="panel2" [attr.aria-selected]="tabActive === 2" [attr.tabindex]="tabActive === 2 ? null : '-1'">
			Ipsum
			<span class="numericBadge" *ngIf="withNumericBadge">8</span>
		</button>
	</li>
	<li class="viewTabs-item" role="presentation">
		<button class="viewTabs-item-tab" type="button" role="tab" id="tab3" aria-controls="panel3" [attr.aria-selected]="tabActive === 3" [attr.tabindex]="tabActive === 3 ? null : '-1'">
			Dolor sit amet
			<span class="numericBadge" *ngIf="withNumericBadge">88</span>
		</button>
	</li>
	<li class="viewTabs-item" role="presentation">
		<button class="viewTabs-item-tab" type="button" role="tab" id="tab4" aria-controls="panel4" [attr.aria-selected]="tabActive === 4" [attr.tabindex]="tabActive === 4 ? null : '-1'">
...
const Template: StoryFn<viewTabsBasicStory> = (args: viewTabsBasicStory) => ({
	props: args,
