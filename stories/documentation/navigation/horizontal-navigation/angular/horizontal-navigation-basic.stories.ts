...
export default {
	...
	decorators: [
		moduleMetadata({
			imports: [HorizontalNavigationComponent, HorizontalNavigationLinkDirective, NumericBadgeComponent, RouterLink, RouterLinkActive],
		}),
		applicationConfig({
	...
	<a *luHorizontalNavigationLink class="horizontalNavigation-list-item-action" routerLink="/" routerLinkActive="active" ariaCurrentWhenActive="page">Page 1${numericBadgeElement}</a>
