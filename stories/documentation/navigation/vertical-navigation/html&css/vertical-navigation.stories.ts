...
export default {
	title: 'Documentation/Navigation/VerticalNavigation/HTML&CSS/Basic',
} as Meta;
...
const Template = (args: VerticalNavigationBasicStory) => ({
	props: args,
	template: getTemplate(args),
});

export const Basic: StoryObj<VerticalNavigationBasicStory> = {
	args: {},
	render: Template,
};
