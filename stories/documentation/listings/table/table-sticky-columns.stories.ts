...
export default {
	title: 'Documentation/Listings/Table/Sticky Columns And Header',
	argTypes: {},
} as Meta;

function getTemplate(args: TableStickyColumnsAndHeaderStory): string {
	return `<!-- header height passed with CSS var -->
		<table class="table mod-layoutFixed mod-stickyColumn mod-stickyHeader" [attr.style]="'--table-stickyHeader-shadow-offset: 2.25rem'">
