	...
	<tbody class="table-body">
		<tr class="table-body-row">
			...
			<td class="table-body-row-cell mod-actions">
				<button class="actionIcon mod-small">
		...
		<tr class="table-body-row">
			...
			<td class="table-body-row-cell">Contenu</td>
			<td class="table-body-row-cell mod-actions">
				<button class="actionIcon mod-small"><span aria-hidden="true" class="lucca-icon icon-edit"></span></button>
				<button class="actionIcon mod-small"><span aria-hidden="true" class="lucca-icon icon-trash"></span></button>
			</td>
		</tr>
		<tr class="table-body-row">
			<td class="table-body-row-cell">Contenu</td>
