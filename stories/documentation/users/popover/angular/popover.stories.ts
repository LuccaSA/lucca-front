...
@Component({
	...
	standalone: true,
	template:
		'<button class="u-buttonReset u-inlineSizeFitContent pr-u-focusVisible u-borderRadiusM" type="button" [luUserPopover]="luUserPopover" [luUserPopoverDisabled]="luUserPopoverDisabled">Survolez-moi !</button>',
