...
function getTemplate(args: CheckboxBasicStory): string {
	...
	<div class="inlineMessage${messageState}" id="${id}message" *ngIf="message"><span aria-hidden="true" class="lucca-icon inlineMessage-content-statusIcon"></span>${message}</div>
</div>`;
}
