...
@Component({
	...
	standalone: true,
	imports: [LuSelectInputComponent, LuOptionModule, LuInputModule, NgPlural, NgPluralCase, FormsModule, ChipComponent, ClearComponent, LuInputDirective, LuInputDisplayerDirective],
	template: \`
	<label class="textfield">
		<lu-select
