...
Basic.args = {
	...
	title: 'Title',
	content:
		'<div class="grid rwd-autoContainer mod-form" style="background-color: var(--palettes-neutral-50)"><div class="grid-column" style="--grid-colspan: 4">Lorem ipsum dolor sit amet.</div></div>',
};
