...
function getTemplate(args: FieldsetBasicStory): string {
	...
	const helper = args.helper
		? `
				<span class="fieldset-title-content-text-helper">${args.helper}</span>`
		: ``;
	...
	<div class="fieldset-content" [attr.hidden]="expanded ? null : 'hidden'">${content}
	</div>
</fieldset>`;
	else
	...
	<div class="fieldset-content">${content}
	</div>
</fieldset>`;
}
