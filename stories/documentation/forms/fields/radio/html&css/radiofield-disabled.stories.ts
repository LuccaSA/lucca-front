...
<div class="form-field">
	...
	<span class="radioField">
		<input disabled="disabled" type="radio" class="radioField-input" id="IDradioA" name="radioName1" aria-describedby="IDmessageRadioA" aria-required="true" />
...
const Template: StoryFn<RadioDisabledStory> = (args: RadioDisabledStory) => ({
	props: args,
