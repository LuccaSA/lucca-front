...
import { DropdownActionComponent, DropdownDividerComponent, DropdownGroupComponent, DropdownItemComponent, LuDropdownModule, LuDropdownTriggerDirective } from '@lucca-front/ng/dropdown';
...
const Template: StoryFn = (args) => ({
	props: args,
	moduleMetadata: {
		imports: [LuDropdownModule, IconComponent, ButtonComponent, DropdownItemComponent, DropdownActionComponent, DropdownDividerComponent, DropdownGroupComponent, IconComponent],
	},
	template: `<button type="button" luButton [luDropdown]="dropdownSample">Dropdown</button>

<lu-dropdown #dropdownSample>
	<lu-dropdown-item>
