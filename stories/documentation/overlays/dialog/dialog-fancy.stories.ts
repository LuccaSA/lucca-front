...
<div
	...
	[attr.style]="'--components-dialog-inside-backgroundImageForeground: url(https://cdn.lucca.fr/transverse/prisme/visuals/fancy-dialog/foreground-${args.illustration}.svg)'"
>
...
export default {
	...
	argTypes: {
		...
		illustration: {
			options: ['approval', 'calc', 'checklist', 'email', 'install', 'mapping', 'save', 'users', 'welcome'],
			control: {
				type: 'select',
			},
		},
