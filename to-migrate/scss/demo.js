...
function toastCommInApp() {
	...
	var toastsCommInAppValues = [
		...
		<button type="button" class="button mod-outline mod-white mod-smaller">Try now</button><button type="button" class="button mod-link mod-invert mod-smaller">Later</button></div>',
	];
