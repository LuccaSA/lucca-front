...
Cette skill documente **Lucca Front 21.0.0**. C'est la version installée sur le projet — tous les chemins ci-dessous lui sont relatifs. Il n'y a rien à détecter.
