...
**Résumé** : 41 ajouté(s), 160 modifié(s), 1 supprimé(s)
...
- 📉 `references/components/multilanguagefield/design/design.md` réduit (97 → 66 lignes)
...
- 🔄 `references/components/callout-popover/callout-popover.md` (42 → 44, +2)
...
- 🔄 `references/components/dialog/dialog.md` (73 → 75, +2)
...
- 🔄 `references/components/dialog/stories/html-dialog.md` (171 → 187, +16)
...
- 🔄 `references/components/fancy-dialog/fancy-dialog.md` (71 → 73, +2)
...
- 🔄 `references/components/footer/design/design.md` (144 → 160, +16)
...
- 🔄 `references/components/multilanguagefield/design/design.md` (97 → 66, -31)
  ...
  @@ ... 46 changement(s) supplémentaire(s) @@
  ````
...
- 🔄 `references/components/skeleton/skeleton.md` (100 → 100, +0)
