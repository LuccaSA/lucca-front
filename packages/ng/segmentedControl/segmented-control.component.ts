...
import { booleanAttribute, Component, forwardRef, input, signal, viewChildren, ViewEncapsulation } from '@angular/core';
import { ReactiveFormsModule } from '@angular/forms';
import { LuccaIcon } from '@lucca-front/icons';
import { Palette } from '@lucca-front/ng/core';
import { injectNgControl, NoopValueAccessorDirective } from '@lucca-front/ng/forms';
import { SegmentedControlFilterComponent, SegmentedControlPanelComponent } from './public-api';
...
export class SegmentedControlComponent {
	...
	segmentedControlFilters = signal<SegmentedControlFilterComponent[]>([]);
