...
| ----------- | ------- | ------- |
| Replace the `size` input of file upload components (`S` became the default value, `L` restores the previous rendering) | 22.0.3+ | `ng g @lucca-front/ng:file-upload-size` |
