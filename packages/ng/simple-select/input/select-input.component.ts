...
import { ChangeDetectionStrategy, Component, forwardRef, HostBinding, inject, input, Input, viewChild, ViewContainerRef, ViewEncapsulation } from '@angular/core';
...
export class LuSimpleSelectInputComponent<T> extends ALuSelectInputComponent<T, T> implements ControlValueAccessor {
	intl = input(...intlInputOptions(LU_SIMPLE_SELECT_TRANSLATIONS));
