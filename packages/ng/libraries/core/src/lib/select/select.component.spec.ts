...
describe('LuSelect', () => {
	...
	it('It should reference the right clearer', () => {
		...
		const luSelect: LuSelect<any> = fixture.debugElement.query(
			By.directive(LuSelect),
		).componentInstance;
		const luClearer: LuSelectClearerFirstOrDefaultComponent<
			any
		> = fixture.debugElement.query(
			By.directive(LuSelectClearerFirstOrDefaultComponent),
		).componentInstance;
	...
	it('It should take the empty value of clearer if clearable', () => {
		...
		const luSelectClearer: LuSelectClearerFirstOrDefaultComponent<
			any
		> = fixture.debugElement.query(
			By.directive(LuSelectClearerFirstOrDefaultComponent),
		).componentInstance;
