...
describe('LuSelectSearcher', () => {
	beforeEach(() => {
		TestBed.configureTestingModule({
			providers: [Platform, LuSelectSearchIntl, LuSelectIntl],
			declarations: [LuSelectOption, LuSelectSearcherComponent],
			imports: [FormsModule],
		}).compileComponents();
	});
	...
	it('It should filter the options', () => {
		...
		TestBed.configureTestingModule({
			declarations: [
				...
				WrapperSearcherElementComponent,
			],
		});
		const fixture = TestBed.createComponent(WrapperSearcherElementComponent);
		const wrapper = fixture.componentInstance;
		fixture.detectChanges();
		const searcher: LuSelectSearcherComponent<any> = fixture.debugElement.query(
			By.directive(LuSelectSearcherComponent),
		).componentInstance;
		fixture.detectChanges();

		// Act
		fixture.whenStable().then(() => {
			const filteredOptions = searcher.filter(
				globalOptions[0].name,
				searcher.luOptions.toArray(),
			);
	...
	it(
		'It should filter the options (displayed)',
		fakeAsync(() => {
			// Arrange
			TestBed.configureTestingModule({
				declarations: [
			...
			const wrapper = fixture.componentInstance;
			fixture.detectChanges();
			const searcher: LuSelectSearcherComponent<
				any
			> = fixture.debugElement.query(By.directive(LuSelectSearcherComponent))
				.componentInstance;
			...
			fixture.whenStable().then(() => {
				...
				const filterArray = searcher.luOptions
					.toArray()
					.filter(option => option.displayed);
