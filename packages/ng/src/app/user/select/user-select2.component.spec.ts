...
@Component({
	template: `<user-select2 [(ngModel)]="item">
		</user-select2>
	`,
})
...
describe('LuUserSelect', () => {
	...
	beforeEach(() => {
		TestBed.configureTestingModule({
			...
			declarations: [LuSelectOption, LuSelect, LuSelectPicker, LuSelectDirective, LuUserPicker, LuUserSelect2, WrapperUserSelect]
		}).compileComponents();
	...
	it('It should call the user service at first', () => {
		// Arrange
		const fixture = TestBed.createComponent(LuUserSelect2);
	...
	it('It should reference has the right value', () => {
		...
		const userSelect: LuUserSelect2<any> = fixture.debugElement.query(By.directive(LuUserSelect2)).componentInstance;
		fixture.detectChanges();
