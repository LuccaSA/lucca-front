...
export function updateAngularJson(tree: Tree) {
	...
	projects[defaultProject].architect.build.options.stylePreprocessorOptions = {
		includePaths: ['src/scss/overrides', 'src/scss', 'node_modules/@lucca-front/ng/src/overrides', 'node_modules/@lucca-front/scss/src/overrides', 'node_modules/@lucca-front/ng/src'],
	};
