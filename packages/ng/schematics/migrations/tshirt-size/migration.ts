...
import { PostCssSelectorParserLib } from '../../lib/local-deps/postcss-selector-parser';
import { PostCssScssLib, removeImportNode, updateCSSClassNamesInRules, updateCSSVariableNames, updateMixinNames } from '../../lib/scss-ast.js';
