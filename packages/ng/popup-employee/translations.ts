export const Translations = {
	...
	pl: {
		EMPLOYEE_CARD_PANEL_COMING_ON_LABEL: 'Planowane przybycie {{date}}',
		EMPLOYEE_CARD_PANEL_ABSENCE_LABEL: 'Nieobecny',
		EMPLOYEE_CARD_PANEL_MORNING_LABEL: 'Poranek',
		EMPLOYEE_CARD_PANEL_PRESENT_LABEL: 'Obecny',
		EMPLOYEE_CARD_PANEL_EMPLOYEE_HAS_LEAVED_LABEL: 'Odszedł',
		...
		EMPLOYEE_CARD_PANEL_UNTIL_DATE_LABEL: 'Dopóki {{date}} dołączony',
