export const Translations = {
	'nl-BE': {
		...
		EMPLOYEE_CARD_PANEL_WORKING_LOCATION: 'Plaats',
	...
	it: {
		...
		EMPLOYEE_CARD_PANEL_PLANNING: 'Congedo per motivi familiari',
	},
	fr: {
	...
	pt: {
		...
		EMPLOYEE_CARD_PANEL_PLANNING: 'Planeamento',
	},
	es: {
		...
		EMPLOYEE_CARD_PANEL_PRESENT_LABEL: 'Presente',
		EMPLOYEE_CARD_PANEL_EMPLOYEE_HAS_LEAVED_LABEL: 'Inactivo/a',
	...
	de: {
		...
		EMPLOYEE_CARD_PANEL_PLANNING: 'Planung',
	},
	en: {
		...
		EMPLOYEE_CARD_PANEL_PLANNING: 'Schedule',
	},
	pl: {
		EMPLOYEE_CARD_PANEL_COMING_ON_LABEL: 'Planowane rozpoczęcie pracy w dniu {{date}}',
		EMPLOYEE_CARD_PANEL_ABSENCE_LABEL: 'Nieobecny(-a)',
		EMPLOYEE_CARD_PANEL_MORNING_LABEL: 'Rano',
		EMPLOYEE_CARD_PANEL_PRESENT_LABEL: 'Obecny(-a)',
		EMPLOYEE_CARD_PANEL_EMPLOYEE_HAS_LEAVED_LABEL: 'Były(-a)',
		EMPLOYEE_CARD_PANEL_UNTIL_TODAY_LABEL: 'Dzisiaj',
		EMPLOYEE_CARD_PANEL_UNTIL_TODAY_LABEL_MORNING: 'Dziś rano',
		EMPLOYEE_CARD_PANEL_UNTIL_TOMORROW_LABEL: 'Do jutra',
		EMPLOYEE_CARD_PANEL_UNTIL_TOMORROW_MORNING_LABEL: 'Do jutra rano',
		EMPLOYEE_CARD_PANEL_UNTIL_DATE_LABEL: 'Do {{date}} włącznie',
		EMPLOYEE_CARD_PANEL_UNTIL_MORNING_DATE_LABEL: 'Do {{date}} rano',
		EMPLOYEE_CARD_PANEL_WORKING_LOCATION: 'Lokalizacja',
		EMPLOYEE_CARD_PANEL_PLANNING: 'Harmonogram',
	},
};
