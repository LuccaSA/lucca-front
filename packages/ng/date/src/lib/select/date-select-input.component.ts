...
import { LuDateAdapterModule } from '../adapter';
...
@Component({
	...
	standalone: true,
	imports: [LuDateAdapterModule, LuDatePickerComponent, LuInputModule, OverlayModule, LuInputClearerComponent, LuInputDisplayerModule],
	providers: [
		{
