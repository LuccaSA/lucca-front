Vue.component('demo-forms-checkboxes', {
	template: `
...
&lt;/div&gt;
				...
				<em><b>Tip:</b> To disable a checkbox, add a <code class="code">disabled</code> attribute to the checkbox input.</em>
			</section>

			<!-- Incomplete checkbox -->
			<section class="contentSection">
				<h3>Incomplete checkbox</h3>
				<div class="checkbox">
