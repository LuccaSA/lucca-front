...
> **Note :** contrairement à la page Prisme, les tables *Classes* et *Variables CSS* conservent les dépréciations déjà supprimées (Suppression ≤ 21.1). Prisme purge les entrées une fois la suppression livrée ; le linter (et cette page) les conserve pour signaler l'usage résiduel.
